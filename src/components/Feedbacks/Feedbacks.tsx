...
export default function Feedbacks() {
  ...
  const FEEDBACKS = [
    ...
    },
    {
      name: 'Mikael d.',
      feedback:
        'Ótima vendedora! Faz o serviço muito bem feito e é bem atenciosa.',
      date: '02/01/2024',
      stars: 5,
    },
    {
    ...
    },
    {
      name: 'Arthur S.',
      feedback:
        'Maravilhosa! Voz super imponente e que comunica com muita clareza o proposto. Com certeza escolherei a Geovana para projetos futuros.',
      date: '13/12/2023',
      stars: 5,
    },
    {
    ...
    },
    {
      name: 'Guilherme c.',
      feedback:
        'Gostei muito da narração! Super profissional, compreensiva e comprometida. Agradeço o serviço prestado e o belo atendimento! :)',
      date: '04/09/2023',
      stars: 5,
    },
    {
    ...
    },
    {
      name: 'Mari b.',
      feedback:
        'a Geovana é uma excelente profissional fez meu video com muita rapidez e me entregou um trabalho perfeito',
      date: '25/07/2023',
      stars: 5,
    },
    {
